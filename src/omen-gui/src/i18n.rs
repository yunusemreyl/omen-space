...
fn translate_tr(key: &'static str) -> &'static str {
    match key {
        ...
        "overlay_desc" => "Kısayol tuşu ile oyun içi ekran üstü HUD panelini yapılandırın, konumunu ve kısayolunu özelleştirin.",
        "overlay_group" => "Hızlı HUD Katmanı",
        "overlay_enable" => "Hızlı Katmanı Etkinleştir",
        "overlay_enable_sub" => "Kısayol tuşu için katmanı arka planda hazır tutar",
        ...
        "overlay_preview_desc" => "Kısayol tuşuna bastığınızda ekranda cam efektli koyu tema HUD belirir. Oyunlardan çıkmadan anında profil değiştirebilirsiniz.",
        "overlay_position_group" => "KONUM AYARLARI",
        "overlay_position_title" => "Ekran Konumu",
        "overlay_position_sub" => "Overlay'in ekranda nerede açılacağını seçin",
        ...
        "overlay_hotkey_sub" => "Overlay'i oyun içinde açıp kapatacak tuş kombinasyonu",
        ...
        "overlay_margin_sub" => "Overlay ile ekran kenarı arasındaki boşluk (piksel)",
