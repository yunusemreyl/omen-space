...
fn translate_tr(key: &'static str) -> &'static str {
    match key {
        ...
        "rgb_paint_hint" => "İlk renk seçiminizi yapıp boyamak istediğiniz tuşlara/bölgelere tıklayın.",
        ...
        "thermal_prot_active" => "⚠️ Yüksek sıcaklıklardan cihazınızı korumak için max fan modu aktif edildi.",
        "thermal_prot_inactive" => "✅ Sıcaklıklar normale döndü, termal koruma devre dışı.",
        ...
        "triage_title" => "Donanım Triage (DSDT & WMI)",
        "triage_sub" => "ACPI tablolarını ve WMI erişim noktalarını tarayarak issue oluşturur",
        "triage_running" => "Triage Raporu Hazırlanıyor",
        "triage_running_body" => "Lütfen bekleyin, ACPI tabloları ve WMI metodları taranıyor...",
...
fn translate_en(key: &'static str) -> &'static str {
    match key {
        ...
        "title_lighting" => "RGB Studio",
        "rgb_paint_hint" => "Select a color first, then click the keys/zones you want to paint.",
        ...
        "thermal_prot_active" => "⚠️ Max fan mode activated to protect your device from high temperatures.",
        "thermal_prot_inactive" => "✅ Temperatures normalized, thermal protection disabled.",
        ...
        "triage_title" => "Hardware Triage (DSDT & WMI)",
        "triage_sub" => "Scans ACPI tables and WMI endpoints to create an issue",
        "triage_running" => "Preparing Triage Report",
        "triage_running_body" => "Please wait, scanning ACPI tables and WMI methods...",
